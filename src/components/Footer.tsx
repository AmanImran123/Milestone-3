export default function Footer() {
   return(
      <footer className="bg-gray-950 pt-12 pb-6 font-[sans-serif] tracking-wide mx-auto flex sm:justify-evenly">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:flex lg:items-center">
          <p className="text-white text-5xl font-bold">Atif<span className="text-blue-600 text-5xl font-bold">Blogs</span></p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 pl-2">
              <li>
                <a href="" className="text-gray-300 hover:text-white text-sm">Featured</a>
              </li>
              <li>
                <a href="" className="text-gray-300 hover:text-white text-sm">New Arrivals</a>
              </li>
              <li>
                <a href="" className="text-gray-300 hover:text-white text-sm">New Arrivals</a>
              </li>
        ...
        <p className='text-gray-300 text-sm mt-10'>©2025 All rights reserved.
        </p>
      </div>
    </footer>
   )
