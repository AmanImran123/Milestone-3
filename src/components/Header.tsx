...
export default function Header() {
  return (
    <div className="text-white">
      <header className="flex border-b py-3 px-4 sm:px-10 bg-gray-900 font-[sans-serif] 
      min-h-[65px] tracking-wide relative z-50">

        {/* Logo */}
        <div className="flex items-center gap-4 max-w-screen-xl mx-auto w-full">
          <p className="text-White text-xl md:text-5xl font-bold">Atif<span className="text-blue-600 text-xl md:text-5xl font-bold">Blogs</span></p>

          <div
            id="collapseMenu"
            className="max-lg:hidden lg:!block max-lg:w-full max-lg:fixed max-lg:before:fixed
             max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50"
          >
            <button
              id="toggleClose"
              className="lg:hidden fixed top-2 right-4 z-[100] rounded-full bg-white w-9 h-9 
            ...
            <ul className="lg:flex lg:ml-14 lg:gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
              ...
              <li className="max-lg:border-b max-lg:py-3 px-3">
                <a
                  href=""
                  className="lg:hover:text-[#007bff] text-gray-200 block text-[15px]"
                >
                  Feature
                </a>
              </li>
